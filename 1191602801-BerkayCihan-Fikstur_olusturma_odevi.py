...
with open('Takimlar.txt','r',encoding="ISO-8859-1") as file:  #takımlar dosyasını okuyoruz encoding için ISO-8859-1 kullandım utf-8 sorun çıkardı
    takim_liste=[]
    for i in file:
...
with open('Fikstur.txt','w',encoding="ISO-8859-1") as file2:  #fikstur.txt dosyasına yazma islemi burada
    #pass
    """
